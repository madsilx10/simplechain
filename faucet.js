...
async function claimFaucet(address) {
  ...
  try {
    ...
    // Menggunakan 'commit' supaya gak kena ERR_ABORTED di awal oleh Cloudflare
    ...
    // --- PROSES CLICK SUBMIT ---
    // Selector diperbarui menjadi lebih universal agar tidak timeout lagi
    const btn = page.locator('button, input[type="button"], .btn, [class*="button"]').first();
